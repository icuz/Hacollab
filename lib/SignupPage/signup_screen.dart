...
import 'package:hacollab1/Services/global_variables.dart';
  ...
  void _submitFormOnSignUp() async{
    ...
    if(isValid) {
      ...
      try{
        ...
        GlobalMethods.showErrorDialog(error: toString(), ctx: context);
      }
    }
    setState(() {
      _isLoading = false;
                        ...
                        TextFormField(
                          ...
                          validator: (value){
                            if(value!.isEmpty || value.length < 7) {
                              return 'Please enter a valid password(pass.length>7)';
                            }
                            else{
                              return null;
                            }
