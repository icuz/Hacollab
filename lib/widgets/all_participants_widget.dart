...
class AllParticipantsWidget extends StatefulWidget {
  ...
  @override
  State<AllParticipantsWidget> createState() => _AllParticipantsWidgetState();
}

class _AllParticipantsWidgetState extends State<AllParticipantsWidget> {
